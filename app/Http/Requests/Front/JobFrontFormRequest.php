...
class JobFrontFormRequest extends Request
{
    ...
    public function messages()
    {
        return [
           ...
           'salary_from.required' => __('Please select salary'),
           ...
           'num_of_positions.required' => __('Please select number of students'),
           'gender_id.required' => __('Please select gender preference'),
            'expiry_date.required' => __('Please enter Job hire date'),
