    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Tution Experiences</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Tution Experiences <small>Tution Experiences</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Tution Experiences</span> </div>
                        <div class="actions"> <a href="{{ route('create.job.experience') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Add New Tution Experience</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="jobExperienceDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td><input type="text" class="form-control" name="job_experience" id="job_experience" autocomplete="off" placeholder="Tution Experience"></td>                      
...
<script>
    ...
    function deleteJobExperience(id, is_default) {
        ...
        if (is_default == 1) {
            msg = 'Are you sure? You are going to delete default Tution Experience, all other non default Tution Experiences will be deleted too!';
        }
        if (confirm(msg)) {
