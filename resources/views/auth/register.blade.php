                ...
                <div class="userccount">
                    ...
                    <div class="userbtns">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link {{($c_or_e == 'candidate')? 'active':''}}" data-toggle="tab" href="#candidate" aria-expanded="true">{{__('Tutor')}}</a></li>

                            <li class="nav-item"><a class="nav-link {{($c_or_e == 'employer')? 'active':''}}" data-toggle="tab" href="#employer" aria-expanded="false">{{__('Guardian or Student')}}</a></li>
