        ...
        <div class="row"> 
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    <li>
                        <p>
                           Besttutorservice is a service product 
                           of ABC Ltd. is the Bangladesh's first-ever & most trusted leading online platform
                           for tutors & students. It helps student/parents
                           to find verified & skilled tutors in-person & online in 
                            13 different categories since 2012...
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <li class="postad"><a href="{{ route('post.job') }}">{{__('Post a Tution')}}</a></li>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="bttxt" style="margin-left:65% ">Developed By <a href="https://zaman-it.com/" target="blank" >ZAMANIT</a></div>
